          ...
          <div className="flex items-center justify-between gap-4 px-4 py-3 lg:px-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex h-10 w-10 items-center justify-center rounded-2xl bg-white text-slate-600 shadow-sm ring-1 ring-stone-200 transition-colors hover:bg-stone-100 dark:bg-slate-800 dark:text-slate-200 dark:ring-slate-700 dark:hover:bg-slate-700"
              ...
              <button className="relative flex h-10 w-10 items-center justify-center rounded-2xl bg-white text-slate-600 shadow-sm ring-1 ring-stone-200 transition-colors hover:bg-stone-100 dark:bg-slate-800 dark:text-slate-200 dark:ring-slate-700 dark:hover:bg-slate-700">
                <Bell size={17} />
              ...
              <div className="hidden items-center gap-3 rounded-2xl bg-white px-3 py-2.5 shadow-sm ring-1 ring-stone-200 transition-colors duration-300 dark:bg-slate-800 dark:ring-slate-700 md:flex">
