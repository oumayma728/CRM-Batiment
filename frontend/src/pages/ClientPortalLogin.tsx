        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm text-slate-600">
              Connectez-vous pour accéder à vos devis, chantiers et factures
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-slate-200 bg-white shadow-2xl">
            <div className="p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-slate-300 bg-white py-3 pl-10 pr-4 text-slate-900 placeholder:text-slate-400 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition"
                      required
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="••••••••"
                      className="w-full rounded-xl border border-slate-300 bg-white py-3 pl-10 pr-12 text-slate-900 placeholder:text-slate-400 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition"
                      required
                    />
                    <button
                      type="button"
                ...
                <button
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 px-4 py-3 text-sm font-semibold text-white shadow-lg transition hover:from-blue-700 hover:to-purple-700 disabled:cursor-not-allowed disabled:opacity-60"
                >
            ...
            <div className="border-t border-slate-200 bg-slate-50 px-8 py-4">
              <p className="text-center text-xs text-slate-500">
                ...
                <a href="tel:+33123456789" className="font-medium text-blue-600 hover:text-blue-700">
                  01 23 45 67 89
                </a>
              </p>
            </div>
