...
export default function TechnicoMateriaux() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-xl font-bold text-slate-950">Catalogue Matériaux</h2>
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-12 text-center">
          ...
          <h3 className="font-semibold text-slate-950">Aucun matériau trouvé</h3>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filtered.map((m) => (
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-sm font-bold text-slate-950">{m.nom}</h3>
