          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3">
              <select
                ...
                className="px-3 sm:px-4 py-2 sm:py-2.5 rounded-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs sm:text-sm"
              >
              ...
              {(search || selectedType || selectedStatut) && (
                <button
                  ...
                  className="px-3 sm:px-4 py-2 sm:py-2.5 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors text-xs sm:text-sm"
                >
                  Effacer
                </button>
              )}
