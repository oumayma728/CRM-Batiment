...
export class QueryCommandesFournisseurDto {
  @ApiPropertyOptional({
    example: 1,
  ...
  @ApiPropertyOptional({
    example: 'BAF-2026-0007',
    description:
      'Recherche par reference, devis, fournisseur, client, chantier ou adresse',
  })
  @IsOptional()
  @IsString()
  search?: string;
  ...
  @ApiPropertyOptional({
    ...
    description: 'Filtre sur le statut logistique fournisseur',
  })
  @IsOptional()
